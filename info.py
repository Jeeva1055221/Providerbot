...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002369002372') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002164950556') # request channel id ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kutty:1512@cluster1.tb1y11c.mongodb.net/?retryWrites=true&w=majority&appName=Cluster1")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+hiveoUbOYqk1YzA9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/CCMTamil')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Get_Movie') # Tutorial video link for opening shortlink website 
